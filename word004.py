...
# b=open("E:\\pythonworking\\file\\aa2\\result.xlsx","w")
...
#   name = t.cell(0,1).text#表示在编教职工数位于表格中第一行第五列，注意这个需要试，还有，行列的起始位置都是从0开始计算的
...
#b.write()的意思是保存输出的结果，其中os.path.splitext(doc)[0]是docx的名字，但是不包含.docx
  # b.write(os.path.splitext(doc)[0]+":"+name+"\n")
  # result=open("result.xlsx","w",encoding="gbk")
  # result.write(str(a))
...
#
#   # 遍历文件
#   PATH = "E:\\pythonworking\\file\\aa2" # windows文件路径
